 ...
 * V0.1.5.2     2017/04/28      Now sibling nodes can be clicked in bubble mode.
 * V0.1.5.3     2017/09/15      First GUI modification towards iP7 inclusion
 * V0.1.5.4     2017/09/26      GUI elements pretty far; needs to be tested openly
 * V0.1.5.5     2017/10/09      Evaluation can be saved
 * V0.1.6.0     2018/01/08      Starting to implement hierarchically stackable Subtrees
 * V0.1.6.1     2018/02/18      Paused stackable Subtrees and implemented loggable Element History
 * V0.1.7.0     2018/08/07      Paused stackable Subtrees again and started to implement Paul's Server access for better performance
 * V0.1.8.0     2019/05/14      Version with Paul's SQL based database
 * V0.1.9.0     2019/06/23      Restructured uc_browsing_dispatcher and other streamlining
 * ---------------------------------------------------------------------------------------
 */
...
c_DEFAULT_GLOBAL_SETUP.eval_scale_db  = 100.0;  // results in internally saved evaluation of scale -100 ... +100
c_DEFAULT_GLOBAL_SETUP.eval_scale_gui = 5.0;  // results in internally saved evaluation of scale -100 ... +100
